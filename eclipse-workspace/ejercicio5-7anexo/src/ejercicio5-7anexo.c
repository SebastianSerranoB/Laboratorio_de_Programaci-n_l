/*
 ============================================================================
 Name        : ejercicio5-7anexo.c
 Author      : Serrano Belloso Sebastian
 Version     : Division K-1
 ANEXO 5-7:
Modificar la función que calcula el promedio en la opción 4 del Menú, para que el resultado del
promedio lo devuelva por retorno y sea main quien lo imprima por pantalla.
 ============================================================================
 */
