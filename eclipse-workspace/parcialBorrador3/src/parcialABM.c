...
int informar(sAlbum array[], int lenght)
{
	...
	rtn = 0, flagOcupado = 0, contadorAlbumes = 0, contadorFechaPosterior = 0;
		...
		do{
				...
				switch(opcionInformar)
				{
					case 1:
						...
						{
							printf("La cantidad de precios de album debajo del promedio de importes es: %d", contadorAlbumesBajoPromedio);
						}
						else
						{
							printf("\nNo se ingresaron precios de albume debajo del promedio de importes.");
						}
							break;
