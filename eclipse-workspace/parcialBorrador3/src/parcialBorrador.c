...
int main(void)
{
	...
	//INGRESO FORZADO DE ESTRUCTURAS ARTISTA, TIPO DE ARTISTA Y DISCOGRAFICA
	cargaForzadaEstructuras(artistas, MAX_ARTISTA, tipoArtistas, MAX_TIPO_ARTISTA, discograficas, MAX_DISCOGRAFICA);
