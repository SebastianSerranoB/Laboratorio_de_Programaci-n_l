...
int hardcodeAlbumes(sAlbum albumes[], int lenght)
{
	...
	float auxPrecio[] = {1500, 150.25, 899.99, 2001, 500.80};
	sFecha auxFecha[] = {{ 10, 8, 95},{25, 12, 99},{28, 2, 2005},{7,11, 2000},{1, 1, 2010}};
...
int bubbleSort(sAlbum albumes[], int lenght, int criterio, int orden)
{
	int rtn;
	rtn = 0;
