...
int main()
{
    ...
    do{
        ...
        switch(option)
        {
            case 1:
            	if(loadFlag == 0){
            		if(controller_loadFromText("data2.csv",listaPasajeros) == 0 ){
            			loadFlag = 1;
            		}
            	}
            	else{
            ...
            case 2:
            	if(loadFlag == 0){
            		if(controller_loadFromBinary("data2.bin", listaPasajeros) == 0){
            			loadFlag = 1;
            		}
            	}
            	else{
            ...
            case 8:
            	if(loadFlag == 1){
            		if(controller_saveAsText("data2.csv",listaPasajeros) == 0){
            		saveTextFlag = 1;
            		}
            	}
            	else{
            ...
            case 9:
            	if(loadFlag == 1){
            		if(controller_saveAsBinary("data2.bin", listaPasajeros) == 0){
            		saveBinFlag = 1;
            		}
				}
				else{
