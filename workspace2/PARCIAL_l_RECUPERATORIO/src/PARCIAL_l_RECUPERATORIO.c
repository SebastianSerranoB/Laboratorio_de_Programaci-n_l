/*
 ...
 PARCIAL 1-LABORATORIO 1  UTN-FRA 2022
 ============================================================================
 */
...
int main(void)
{
	...
	cargaForzadaEstructuras(artistas, MAX_ARTISTA, tipoArtistas, MAX_TIPO_ARTISTA, discograficas, MAX_DISCOGRAFICA, albumes, MAX_ALBUM, paises, MAX_PAISES);
	 ...
	 do{
		 ...
		 {
			 case 1:
				 	 alta(albumes, MAX_ALBUM, artistas, tipoArtistas, discograficas, paises);
				 	 break;

			 case 2:
				 	modificacion(albumes, MAX_ALBUM, paises, artistas, tipoArtistas, discograficas);
					 break;

			 case 3:
				 	 baja(albumes, MAX_ALBUM, artistas, tipoArtistas, discograficas, paises);
					 break;
			 ...
			 case 5:
				 	 listar(albumes, MAX_ALBUM, artistas, tipoArtistas, discograficas, paises);
				 break;
