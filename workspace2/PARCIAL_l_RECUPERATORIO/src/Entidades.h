...
/**
 * @brief	Recibe un arreglo de tipo struct sAlbum, lo recorre buscando un elemento de ese arreglo dado de ALTA, si al menos uno se encuentra dado de ALTA, retorna (1).
 *
 * @param array[]		-Recibe un arreglo de elemntos de tipo "sAlbum".
 * @param lenght		-La cantidad de elementos que constituyen al arreglo "array[]".
 *
 * @return	Retorna (0) si no encuentra elementos de la estructura dados de alta, con valor OCUPADO(1), de caso contrario retorna (1).
 */
...
/**
 * @brief	Recibe un arreglo de tipo struct "sAlbum" que sera la base para realizar calculos relativos a los datos y valores de este arreglo,
 * 			informa los resultados obtenidos.
 *
 * @param array{}			-Recibe un arreglo de elementos del tipo struct "sAlbum".
 * @param lenght			-La cantidad de elementos que constituyen el arreglo array[];
...
/**
 * @brief Recibe un arreglo de tipo struct "sAlbum" que sera recorrido para buscar la cantidad de albumes argentinos e informar esa cantidad
 *
 *
 * @param albumes[]	-Recibe un arreglo de elementos del tipo struct "sAlbum".
 * @param lenght	-La cantidad de elementos que constituyen el arreglo albumes[];
 */
...
//f
/**
 *@brief	Muestra si existen, albumes con fecha de publicacion posterior al anio 2000.
 *
 * @param albumes			-Recibe un arreglo de tipo struct "sAlbum".
 * @param lenghtAlbumes		-La cantidad de elementos que constituyen al arreglo "albumes[]".
 * @param artistas			-Recibe un arreglo de tipo struct "sArtista".
...
//g
/**
 *@brief	Muestra si existen, albumes con precio debajo del promedio de todos los albumos dados de alta.
 *
 * @param albumes			-Recibe un arreglo de tipo struct "sAlbum".
 * @param lenghtAlbumes		-La cantidad de elementos que constituyen al arreglo "albumes[]".
 * @param artistas			-Recibe un arreglo de tipo struct "sArtista".
...
//h
/**
 *@brief	Muestra albumes de un artista determinado.
 *
 * @param albumes			-Recibe un arreglo de tipo struct "sAlbum".
 * @param lenghtAlbumes		-La cantidad de elementos que constituyen al arreglo "albumes[]".
 * @param artistas			-Recibe un arreglo de tipo struct "sArtista".
...
//i
/**
 *@brief	Muestra todos los albumes de cada año.
 *
 * @param albumes			-Recibe un arreglo de tipo struct "sAlbum".
 * @param lenghtAlbumes		-La cantidad de elementos que constituyen al arreglo "albumes[]".
 * @param artistas			-Recibe un arreglo de tipo struct "sArtista".
...
//j
/**
 *@brief	Muestra el o los albumes mas baratos.
 *
 * @param albumes			-Recibe un arreglo de tipo struct "sAlbum".
 * @param lenghtAlbumes		-La cantidad de elementos que constituyen al arreglo "albumes[]".
 * @param artistas			-Recibe un arreglo de tipo struct "sArtista".
...
//l
/**
 *@brief	Muestra todos los albumes que no sean de Argentina.
 *
 * @param albumes			-Recibe un arreglo de tipo struct "sAlbum".
 * @param lenghtAlbumes		-La cantidad de elementos que constituyen al arreglo "albumes[]".
 * @param artistas			-Recibe un arreglo de tipo struct "sArtista".
...
//m
/**
 *@brief	Muestra albumes Argentinos para un año determinado.
 *
 * @param albumes			-Recibe un arreglo de tipo struct "sAlbum".
 * @param lenghtAlbumes		-La cantidad de elementos que constituyen al arreglo "albumes[]".
 * @param artistas			-Recibe un arreglo de tipo struct "sArtista".
...
/**
 *@brief  Muestra albumes solistas para un año y pais determinado.
 *
 *@param albumes			-Recibe un arreglo de tipo struct "sAlbum".
 * @param lenghtAlbumes		-La cantidad de elementos que constituyen al arreglo "albumes[]".
 * @param artistas			-Recibe un arreglo de tipo struct "sArtista".
