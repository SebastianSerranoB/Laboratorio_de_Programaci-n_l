...
int printOnePassenger(Passenger* this)
{
	...
	if(this != NULL)
	{
		...
		//TENEMOS PROBLEMAS CON LOS GETTERS PARA ID , LOS GETTERS PARA TIPOPASAJERO, EL RESTO IMPRIME BIEN, FALTA CLARO, PRINTEAR EL TEXTO EN ESTADO DE VUELO Y EN TIPOPASAJERO PERO LO PRINTEA
		...
		Passenger_getCodigoVuelo(this, codigoVueloAux);
		 Passenger_getEstadoVuelo(this, &estadoVueloAux);
