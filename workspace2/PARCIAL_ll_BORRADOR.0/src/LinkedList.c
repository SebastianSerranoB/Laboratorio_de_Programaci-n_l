 ...
 * \return int Retorna  (-1) Error: si el puntero a la lista es NULL o (si el indice es menor a 0 o mayor/igual al len de la lista)
                        ( 0) Si funciono correctamente
 *
 */
...
int ll_clear(LinkedList* this)
{
    ...
    //hay que hacerle un free al elemento tambien, corresponde hacerlo en ll_remove //correcion, parece que el garbage collector se encarga
    if(this != NULL)
    {
...
//esta es una manera de hacer el mapeo, aca separamos el mapeo en una nueva lista, tambien podemos mapear la original
