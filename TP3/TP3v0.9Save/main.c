...
int main()
{
    ...
    do{
        ...
        switch(option)
        {
            case 1:
            	if(loadFlag == 0){
            		controller_loadFromText("dataAux.csv",listaPasajeros);
            		loadFlag = 1;
            	}
            	else{
            ...
            case 2:
            	if(loadFlag == 0){
            		controller_loadFromBinary("databAux.bin", listaPasajeros);
            		loadFlag = 1;
            	}
            	else{
            		printf("\nLa lista puede cargarse solo una ves.");
            ...
            case 8:
            	if(loadFlag == 1){
            		controller_saveAsText("dataAux.csv",listaPasajeros);
            		saveTextFlag = 1;
            	}
            	else{
            ...
            case 9:
            	if(loadFlag == 1){
            		controller_saveAsBinary("databAux.bin", listaPasajeros);
            		saveBinFlag = 1;
				}
				else{
					printf("\nCARGUE LA LISTA DE PASAJEROS ANTES DE GUARDAR.");
