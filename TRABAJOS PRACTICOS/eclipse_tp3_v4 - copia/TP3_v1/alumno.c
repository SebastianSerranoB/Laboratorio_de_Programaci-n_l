 ...
 * */
int conversorTipoPasajero(char* tipoPasajeroAux, int* tipoPasajero)
{
	int rtn;
	rtn = -1;
...
int conversorEstadoVuelo(char* estadoVueloAux, int* estadoVuelo)
{
	int rtn;
	rtn = -1;
...
int mainMenu()
{
	...
	printf("\n\n==================  MENU PRINCIPAL  ==================\n\n"
			...
			"2. Cargar los datos de los pasajeros desde el archivo data.csv (modo binario).\n"
			"3. Alta de pasajero\n 4. Modificar datos de pasajero\n5. Baja de pasajero\n"
			" 6. Listar pasajeros7. Ordenar pasajeros\n 8. Guardar los datos de los pasajeros en el archivo data.csv (modo texto).\n"
			"9. Guardar los datos de los pasajeros en el archivo data.csv (modo binario).\n\n 10. Salir\n"
			"==========================================================\n\n");
	opcion = getInt(1, 10, "\nIngrese una opcion: ");
