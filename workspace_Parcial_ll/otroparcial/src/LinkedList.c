...
/** \brief Devuelve una linkedlist con los elementos modificados segun el criterio
 * \param pList LinkedList* Puntero a la lista
 * \param pFunc (*pFunc) Puntero a la funcion criterio
 * \return LinkedList* Retorna  (NULL) Error: si el puntero a la listas es NULL o puntero a funcion es NULL
                                (newLinkedList) Si ok
 */
